...
const ROLE_TABS: Record<RoleType, AdminTab[]> = {
  site_admin:    ['pc', 'queue', 'bypasses', 'games', 'drinks', 'reports', 'admins', 'manual-tx', 'ic-entry', 'ic-dashboard', 'tennis', 'credit'],
  manager:       ['queue', 'bypasses', 'games', 'drinks', 'reports', 'tennis', 'credit'],
